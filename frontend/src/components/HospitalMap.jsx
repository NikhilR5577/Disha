...
const HospitalMap = ({ locations, route }) => {
  ...
  return (
    <div className="relative w-full h-full overflow-hidden bg-[#e5e7eb] shadow-sm flex items-center justify-center p-4">
      ...
      <div className="relative shadow-2xl rounded-lg overflow-hidden" style={{ width: '100%', height: 'auto', aspectRatio: `${SVG_W}/${SVG_H}`, maxWidth: '100%', maxHeight: '100%', backgroundColor: '#fff' }}>
